...
//        list.setBackgroundColor(Color.RED);
    ...
    public String houseHoldMainCount() {
        return "Select Count(*) from (Select *, " +
                "(Select count(*)  from ec_elco where ec_elco.relational_id = ec_family.base_entity_id) as ELCO " +
                "from ec_family) ec_family ";
    }
    ...
    public void initializeQueries() {
        try {
            ...
            clientAdapter = new SmartRegisterPaginatedCursorAdapter(getActivity(), null, hhscp, new CommonRepository("ec_family", new String[]{"FWHOHFNAME", "FWGOBHHID", "FWJIVHHID", "existing_Mauzapara", "ELCO"}));
            clientsView.setAdapter(clientAdapter);

            setTablename("ec_family");
            ...
            String elcoCountSubQuery = "(Select count(*)  from ec_elco where ec_elco.relational_id = ec_family.base_entity_id) as ELCO";

            SmartRegisterQueryBuilder queryBUilder = new SmartRegisterQueryBuilder();
            queryBUilder.selectInitiateMainTable("ec_family", new String[]{"relationalid", elcoCountSubQuery, "FWHOHFNAME", "FWGOBHHID", "FWJIVHHID", "existing_Mauzapara"});
...
//                dialogOptionslist.add(new HHMauzaCommonObjectFilterOption(name, "location_name", name, "ec_family"));
